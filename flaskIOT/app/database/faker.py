...
def create_faker(db):
    ...
    # Apartments
    db.session.add(Apartment(apartment_name="Fermi", city="Modena", street="via Garibaldi", apartment_street_number=1, n_internals=155, associated_bingroup=0, associated_admin='rossi1'),
    ...
    #Users
    db.session.add(User(Person(username="rossi1", name="Mario", surname="Rossi", password="ilovecondomini", city="Modena", birth_year=2001), 0, 45),
