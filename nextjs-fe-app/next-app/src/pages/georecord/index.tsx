                                    ...
                                    <div className="lg:w-6/12 px-4 md:px-0">
                                        <div className="md:p-12 md:mx-6">
                                            <div className="text-center">
                                                ...
                                                <span className="font-bold mb-4">{apartment_id}</span>
                                            </div>
                                            <form>
                                                ...
                                                <div id="alert"> {show_alert ? <ErrorAlert alert_type={'dang'} body_message={"Please confirm by checking the checkbox in order to confirm you want to init this apartment"}></ErrorAlert> : null} </div>
