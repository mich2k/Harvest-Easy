                        ...
                        <section className="h-full gradient-form bg-gray-200 md:h-screen">
                            <div className="overflow-auto container py-12 px-6 h-full">
                                <div className="overflow-auto flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
                                    <div className="overflow-auto xl:w-10/12">
                                        <div className="overflow-auto block bg-white shadow-lg rounded-lg">
                                            <div className="overflow-auto lg:flex lg:flex-wrap g-0">
