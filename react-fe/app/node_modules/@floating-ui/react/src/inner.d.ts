 ...
 * @see https://floating-ui.com/docs/inner
 */
export declare const useInnerOffset: ({ open, refs }: FloatingContext, { enabled, overflowRef, scrollRef, onChange: unstable_onChange, }: UseInnerOffsetProps) => ElementProps;
