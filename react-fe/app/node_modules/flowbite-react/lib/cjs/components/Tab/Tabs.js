...
exports.TabsComponent = (0, react_1.forwardRef)(({ children, style = 'default', className, onActiveTabChange, ...rest }, ref) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: (0, classnames_1.default)(theme.base, className), children: [(0, jsx_runtime_1.jsx)("div", { "aria-label": "Tabs", role: "tablist", className: (0, classnames_1.default)(theme.tablist.base, theme.tablist.styles[style], className), ...rest, children: tabs.map((tab, index) => ((0, jsx_runtime_1.jsxs)("button", { type: "button", "aria-controls": `${id}-tabpanel-${index}`, "aria-selected": index === activeTab, className: (0, classnames_1.default)(theme.tablist.tabitem.base, { ...tabItemStyle }, {
